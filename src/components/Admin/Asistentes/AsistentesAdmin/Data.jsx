...
export const Data = ({ id, nombreCompleto, email, ingreso }) => {
  ...
  const enterTheEvent = () => {
    const redirectAsistences = true;

    dispatch(setIsLoading(true))
    dispatch(entranceByQrCode(id, nombreCompleto, redirectAsistences));
  };
  ...
  return (
    <div key={id}>
      ...
      <ModalData modalData={modalData} setModalData={setModalData} id={id} />
    </div>
  );
};
